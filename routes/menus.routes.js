...
const {getMenuValidator,createMenuValidator,updateMenuValidator,deleteMenuValidator} = require("../utils/validator/menuValidator")

router.get("/",getMenus);
router.post("/",authorisation("admin"),createMenuValidator,createMenu);
